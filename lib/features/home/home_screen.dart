...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String bestGameSource = 'Skor terbaik';
  ...
  Future<String> _readBestGameSource(Map<String, int> records) async {
    ...
    if (bestScore <= 0) return 'Skor terbaik';
  ...
  Future<void> _loadHome() async {
    ...
    Map<String, dynamic>? latestGame;
    String nextBestGameSource = 'Skor terbaik';
    ...
    nextBestGameSource = await _readBestGameSource(records);
            ...
            children: [
              ...
              Expanded(
                child: _summaryMiniCard(
                  title: 'GAMES',
                  value: '$bestScore',
                  subtitle: bestScore <= 0 ? 'Skor terbaik' : bestGameSource,
                  color: _purple,
                ),
              ),
            ],
